...
try {
    ...
    if ($check_result->num_rows === 0) {
        throw new Exception("You don't have permission to archive this note.");
    }
    
    // Archive the note
    $sql = "UPDATE notes SET archived = 1 WHERE id = ? AND user_id = ?";
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['error'] = "Error archiving note: " . $stmt->error;
    }
